...
// New struct to hold fruit properties
...
// Define a struct for leaf properties
...
private:
	...
	// load instantiation of fruit in boxes	 - Added by AEV
	std::vector<glm::vec3> strawberryPositions;
	std::vector<glm::vec3> blueberryPositions;
	bool fruitsInitialized;
	...
	// naming vectors to instiate multiple random fruit
	std::vector<FruitProperties> strawberries;
	std::vector<FruitProperties> blueberries;

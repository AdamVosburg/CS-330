...
namespace
{
    ...
    // New variable to control camera movement speed
    float gMovementSpeed = 60.0f;
}
    ...
    ShaderManager* pShaderManager)
{
    ...
    // Adjusted camera view parameters - now positioned to the left
    g_pCamera->Position = glm::vec3(-10.0f, 8.0f, 10.0f);  // Moved left, up, and back
    g_pCamera->Front = glm::vec3(0.5f, -0.5f, -1.0f);      // Looking diagonally down and right
...
GLFWwindow* ViewManager::CreateDisplayWindow(const char* windowTitle)
{
    ...
    // Add mouse scroll callback for adjusting movement speed
...
void ViewManager::Mouse_Scroll_Callback(GLFWwindow* window, double xoffset, double yoffset)
{
    ...
    gMovementSpeed = glm::clamp(gMovementSpeed, 1.0f, 50.0f);
    g_pCamera->MovementSpeed = gMovementSpeed;
}
